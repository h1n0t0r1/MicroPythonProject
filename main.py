...
pwm_1 = PWM(1, duty_u16=MOTOR_OFF)
invert_pwm_1 = Pin(10, Pin.OUT)
pwm_2 = PWM(2, duty_u16=MOTOR_OFF)
invert_pwm_2 = Pin(11, Pin.OUT)
pwm_3 = PWM(5, duty_u16=MOTOR_OFF)
invert_pwm_3 = Pin(12, Pin.OUT)
pwm_4 = PWM(7, duty_u16=MOTOR_OFF)
invert_pwm_4 = Pin(13, Pin.OUT)
power_pin.value(1)
